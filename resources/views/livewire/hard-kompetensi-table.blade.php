                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right p-1"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center py-1"
                                        href="{{ route('adminsdm.data-master.kompetensi.edit', ['id' => $item->id_kompetensi, 'from' => 'hard']) }}">
                                        <i class="fas fa-edit text-warning mr-2" style="width: 18px;"></i> Edit
                                    </a>
                                    <a class="dropdown-item d-flex align-items-center py-1"
                                        href="{{ route('adminsdm.data-master.kompetensi.showHard', $item->id_kompetensi) }}">
                                    ...
                                    <a href="#" class="dropdown-item text-danger d-flex align-items-center py-1"
                                        onclick="event.preventDefault(); if(confirm('Yakin ingin menghapus data ini?')) document.getElementById('delete-kompetensi-hard-{{ $item->id_kompetensi }}').submit();">
                                        <i class="fas fa-trash-alt mr-2" style="width: 18px;"></i> Hapus
                                    </a>
                                    <form id="delete-kompetensi-hard-{{ $item->id_kompetensi }}"
