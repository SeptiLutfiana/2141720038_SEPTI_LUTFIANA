...
@section('title', 'Isi Evaluasi Karyawan')

@section('main')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Evaluasi {{ ucfirst($jenisEvaluasi) }}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('karyawan.dashboard-karyawan') }}">Dashboard</a>
                    </div>
                    <div class="breadcrumb-item active"><a
                            href="{{ route('karyawan.EvaluasiIdp.EvaluasiPascaIdp.indexKaryawan') }}">Data Evaluasi</a>
                    </div>
                    <div class="breadcrumb-item">Kerjakan Evaluasi IDP</a></div>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h4>Pertanyaan Evaluasi</h4>
                </div>
                <form action="{{ route('karyawan.EvaluasiIdp.EvaluasiPascaIdp.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
