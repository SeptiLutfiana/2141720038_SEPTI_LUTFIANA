...
<body class="font-sans">
    ...
    <div class="container mx-auto px-2 py-2 flex items-center justify-between">
      ...
      <nav class="hidden md:block">
        <ul class="flex space-x-8 items-center">
          ...
          <li>
            <a href="{{ route('login') }}" class="bg-green-700 text-white text-xs font-semibold rounded-md px-4 py-2 hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500">
              Login
            </a>
          </li>
        </ul>
  ...
  <button @click="isOpen = !isOpen" type="button"
    ...
    <svg :class="{'block': isOpen, 'hidden': !isOpen}" class="h-6 w-6 hidden" fill="none" viewBox="0 0 24 24"
      stroke-width="1.5" stroke="currentColor" aria-hidden="true">
      <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        <a href="#home" class="text-gray-900 hover:bg-green-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Home</a>
        <a href="#about" class="text-gray-900 hover:bg-green-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">About Us</a>
        <a href="#fitur" class="text-gray-900 hover:bg-green-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Fitur</a>
        <a href="#benefit" class="text-gray-900 hover:bg-green-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Benefit</a>
        <a href="#contact" class="text-gray-900 hover:bg-green-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Contact Us</a>
        <div class="mt-4"> <a href="{{ route('login') }}" class="items-center bg-green-700 text-white block rounded-md px-3 py-2 text-base font-medium hover:bg-green-800">
    ...
    <div class="container mx-auto px-4 text-left">
        <div class="flex flex-col-reverse md:flex-row items-center md:justify-between max-w-4xl mx-auto">
            <div class="hero-text w-full md:w-1/2 pr-0 md:pr-16 mb-4 md:mb-0 text-center md:text-left">
              ...
              <p class="text-lg text-gray-600 mb-8">MENARA PeFI membantu Anda mengelola pengembangan karir dengan mudah, memantau kompetensi, dan meraih prestasi secara terukur</p>
                <a href="{{ route('login') }}" class="text-white font-bold rounded-md px-8 py-3 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500" style="background-color: #086044;">Login</a>
            </div>
            <div class="hero-image w-full md:w-1/2">
                <img src="./style/img/logo-onbording1.png" alt="Karakter Menara PeFI" class="w-3/4 mx-auto md:ml-auto md:mr-0">
            </div>
        </div>
    </div>
</section>
<section id="about" class="py-18" style="color: #D9D9D9">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-lg text-gray-600 max-w-2xl mx-auto">Selamat datang di platform MENARA PeFI (Monitoring & Navigation Application for Resource Advancement) – solusi digital terdepan untuk mendukung pengembangan kompetensi dan karir di Perhutani Forestry Institute.</p>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-white rounded-lg shadow-md p-6 text-center">
                <img src="./style/img/kompetensi.png" alt="Monitoring Kompetensi" class="h-16 w-auto mx-auto mb-4">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-gray-100 rounded-lg p-6 text-center">
                ...
                <p class="text-gray-600">Dengan fitur IDP, pengguna dapat membuat rencana karir yang terstruktur dan mendapatkan gambaran jelas mengenai langkah-langkah yang perlu diambil untuk mencapai tujuan mereka.</p>
            </div>
            <div class="bg-gray-100 rounded-lg p-6 text-center">
                <img src="./style/img/kompetensi2.png" alt="Peningkatan Kompetensi" class="h-16 w-auto mx-auto mb-4">
...
<section id="contact" class="py-16 bg-gray-100 text-center">
    <div class="container mx-auto px-4">
        ...
        <p class="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
          Kami siap membantu Anda dengan segala pertanyaan atau kebutuhan terkait MENARA PeFI. <br>Jangan ragu untuk menghubungi kami melalui saluran berikut:
        </p>
        <p class="text-lg font-semibold text-gray-700 mb-4">Nikmatul Khoyri Anwar - Humas SDM PeFI</p>
          ...
          <p class="text-gray-600 mb-2">
            ...
            <a href="https://wa.me/6283114135317" target="_blank" class="underline hover:text-green-500">Chat di WhatsApp</a>
          </p>
    </div>
</section>
    ...
    <div class="text-center md:text-left">
      <div class="subscribe">
          ...
          <div class="mt-2 relative">
              <input type="email" placeholder="Your Comment" class="bg-gray-600 text-white rounded-md py-2 px-4 w-full focus:outline-none focus:ring-2 focus:ring-green-500 pr-10"> <button type="submit" class="absolute top-0 right-0 mt-9 mr-0 bg-transparent text-white hover:text-green-300 focus:outline-none">
