        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('adminsdm.data-master.kompetensi.create') }}">Tambah Data Kompetensi</a></div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('adminsdm.data-master.kompetensi.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div id="input-manual">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_kompetensi" class="form-control @error('jenis_kompetensi') is-invalid @enderror">
                            ...
                            <div id="input-upload" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        <br>
                                        Format Tabel: <strong>no</strong>, <strong>nama_kompetensi</strong>, <strong>jenis_kompetensi</strong>, <strong>keterangan</strong>.
                                    </small>
                                </div>
                            </div>
                        </div>
