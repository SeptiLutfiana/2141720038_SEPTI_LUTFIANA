        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="{{ route('adminsdm.data-master.supervisor.index') }}">Data
                            Supervisor</a></div>
                    <div class="breadcrumb-item"><a href="{{ route('adminsdm.data-master.supervisor.create') }}">Tambah Data
                            Supervisor</a></div>
                </div>
            </div>
