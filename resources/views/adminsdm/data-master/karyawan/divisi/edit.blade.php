...
@section('title', 'Halaman Edit Divisi')
        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('adminsdm.data-master.karyawan.divisi.update', $divisi->id_divisi) }}" method="POST">
                        <div class="card-body">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_divisi"
                                    class="form-control @if (old('nama_divisi')) is-valid @endif
                                @error('nama_divisi') is-invalid @enderror"
                            ...
                            <div class="form-group">
                                ...
                                @error('keterangan') is-invalid @enderror"
                                    class="form-control" style="height:8rem;">{{ old('keterangan', $divisi->keterangan) }}</textarea>
                            </div>
                        </div>
