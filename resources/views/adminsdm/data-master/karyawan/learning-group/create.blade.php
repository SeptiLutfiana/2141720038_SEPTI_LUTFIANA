...
@section('title', 'Halaman Tambah Data Learning Group')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a
                            href="{{ route('adminsdm.data-master.karyawan.learning-group.index') }}">Data Direktorat</a>
                    </div>
                    <div class="breadcrumb-item"><a
                            href="{{ route('adminsdm.data-master.karyawan.learning-group.create') }}">Tambah Data
                            Direktorat</a></div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('adminsdm.data-master.karyawan.learning-group.store') }}" method="POST"
                            ...
                            <div id="input-manual">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_LG"
                                        class="form-control @error('nama_LG') is-invalid @enderror"
                                        value="{{ old('nama_LG') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div id="input-upload" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        <br>
                                        Format Tabel: <strong>no</strong>, <strong>nama_LG</strong>,
