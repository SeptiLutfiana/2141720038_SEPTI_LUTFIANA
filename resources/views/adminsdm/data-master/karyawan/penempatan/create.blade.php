        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('adminsdm.data-master.karyawan.penempatan.create') }}">Tambah Data Penempatan</a></div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('adminsdm.data-master.karyawan.penempatan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div id="input-manual">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_penempatan" class="form-control @error('nama_penempatan') is-invalid @enderror" value="{{ old('nama_penempatan') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div id="input-upload" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        <br>
                                        Format Tabel: <strong>no</strong>, <strong>nama_penempatan</strong>, <strong>keterangan</strong>.
                                    </small>
                                </div>
                            </div>
                        </div>
