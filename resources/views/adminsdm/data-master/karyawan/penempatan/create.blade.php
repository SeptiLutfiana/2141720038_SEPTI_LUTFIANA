...
@section('title', 'Halaman Tambah Data Penempatan')

@section('main')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Penempatan</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('adminsdm.dashboard') }}">Dashboard</a></div>
                    <div class="breadcrumb-item active"><a
                            href="{{ route('adminsdm.data-master.karyawan.penempatan.index') }}">Data Penempatan</a></div>
                    <div class="breadcrumb-item"><a
                            href="{{ route('adminsdm.data-master.karyawan.penempatan.create') }}">Tambah Data Penempatan</a>
                    </div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                @if (session('duplikat'))
                    <div class="alert alert-warning">
                        ...
                        <ul>
                            @foreach (session('duplikat') as $dupe)
                                <li>{{ $dupe }}</li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Tambah Data Penempatan</h4>
                    </div>
                    <form action="{{ route('adminsdm.data-master.karyawan.penempatan.store') }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div id="input-manual">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_penempatan"
                                        class="form-control @error('nama_penempatan') is-invalid @enderror"
                                        value="{{ old('nama_penempatan') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div id="input-upload" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        <br>
                                        Format Tabel: <strong>no</strong>, <strong>nama_penempatan</strong>,
