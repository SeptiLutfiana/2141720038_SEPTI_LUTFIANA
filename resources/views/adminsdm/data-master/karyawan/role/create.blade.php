...
@section('title', 'Halaman Tambah Data Role')

@section('main')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Role User</h1>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('adminsdm.data-master.karyawan.role.create') }}">Tambah Data Role</a></div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('adminsdm.data-master.karyawan.role.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div id="input-manual">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_role" class="form-control @error('nama_role') is-invalid @enderror" value="{{ old('nama_role') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div id="input-upload" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        <br>
                                        Format Tabel: <strong>no</strong>, <strong>nama_role</strong>, <strong>keterangan</strong>.
                                    </small>
                                </div>
                            </div>
                        </div>
