        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('adminsdm.data-master.karyawan.data-karyawan.create') }}">Tambah Data Karyawan</a></div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('adminsdm.data-master.karyawan.data-karyawan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div id="input-manual">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_jenjang" class="form-control @error('id_jenjang') is-invalid @enderror">
                                        ...
                                        @foreach ($jenjang as $item)
                                            <option value="{{ $item->id_jenjang }}" {{ old('id_role') == $item->id_jenjang ? 'selected' : '' }}>
                                                {{ $item->nama_jenjang }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="npk" class="form-control @error('npk') is-invalid @enderror" value="{{ old('npk') }}">
                                </div>
                                <div class="form-group">
                                    <label>No Hp</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_LG" class="form-control @error('id_LG') is-invalid @enderror">
                                        ...
                                        @foreach ($LG as $item)
                                            <option value="{{ $item->id_LG }}" {{ old('id_LG') == $item->id_LG ? 'selected' : '' }}>
                                                {{ $item->nama_LG}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_semester" class="form-control @error('id_semester') is-invalid @enderror">
                                        <option value="">-- Pilih Semester --</option>
                                        @foreach ($semester as $item)
                                            <option value="{{ $item->id_semester }}" {{ old('id_semester') == $item->id_semester ? 'selected' : '' }}>
                                                {{ $item->nama_semester}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_angkatanpsp" class="form-control @error('id_angkatanpsp') is-invalid @enderror">
                                        <option value="">-- Pilih Angkatan PSP --</option>
                                        @foreach ($angkatanpsp as $item)
                                            <option value="{{ $item->id_angkatanpsp }}" {{ old('id_angkatanpsp') == $item->id_angkatanpsp ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_divisi" class="form-control @error('id_divisi') is-invalid @enderror">
                                        ...
                                        @foreach ($divisi as $item)
                                            <option value="{{ $item->id_divisi }}" {{ old('id_divisi') == $item->id_divisi ? 'selected' : '' }}>
                                                {{ $item->nama_divisi }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_penempatan" class="form-control @error('id_penempatan') is-invalid @enderror">
                                        <option value="">-- Pilih Penempatan --</option>
                                        @foreach ($penempatan as $item)
                                            <option value="{{ $item->id_penempatan }}" {{ old('id_penempatan') == $item->id_penempatan ? 'selected' : '' }}>
                            ...
                            <div id="input-upload" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        <strong>penempatan</strong>, <strong>lg</strong>, <strong>semester</strong>,<strong>npk</strong>,
