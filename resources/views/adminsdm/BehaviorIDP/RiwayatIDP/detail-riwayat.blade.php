        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('adminsdm.BehaviorIDP.RiwayatIDP.indexRiwayatIdp') }}">Data
                            IDP</a></div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            @endforeach
                            <tr>
                                <th colspan="3">Nilai Soft Kompetensi</th>
                                <th class="text-center">{{ $idps->rekomendasis->first()->nilai_akhir_soft }}</th>
                            </tr>
                            <tr>
                            ...
                            @endforeach
                            <tr>
                                <th colspan="3">Nilai Hard Kompetensi</th>
                                <th class="text-center">{{ $idps->rekomendasis->first()->nilai_akhir_hard }}</th>
                            </tr>
                        </table>
                    ...
                    <div class="card-footer text-right">
                        <a class="btn btn-primary"
                            href="{{ route('adminsdm.BehaviorIDP.RiwayatIDP.indexRiwayatIdp') }}">Kembali</a>
                    </div>
                </div>
            </div>
        </section>
