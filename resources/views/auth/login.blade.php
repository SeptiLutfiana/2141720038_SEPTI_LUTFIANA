    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
      ...
      <div class="flex items-center my-4">
        ...
        <div class="flex justify-center">
          <a href="{{ url('/auth/google/redirect') }}" class="w-full flex items-center justify-center gap-3 py-2 border border-white rounded-xl text-white hover:bg-green-700 transition">
