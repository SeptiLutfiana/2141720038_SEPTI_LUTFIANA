            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a class="btn btn-primary" href="{{ route('mentor.IDP.indexMentor') }}">Kembali</a>
                    </div>
                </div>
            </div>
    </div>
            ...
            <form id="nilaiForm" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="nilaiModalLabel">Persetujuan Implementasi IDP oleh Mentor</h5>
                        ...
                        <div class="mb-3 text-center">
                            ...
                            @foreach ($statuses as $status)
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" name="status_pengerjaan"
