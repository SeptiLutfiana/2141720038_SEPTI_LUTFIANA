...
class SupervisorExport implements FromArray, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'DAFTAR SUPERVISOR INDIVIDUAL DEVELOPMENT PLAN PERHUTANI FORESTRY INSTITUTE');
                // Styling judul
